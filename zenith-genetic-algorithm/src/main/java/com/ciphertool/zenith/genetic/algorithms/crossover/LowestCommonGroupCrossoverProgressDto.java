...
public class LowestCommonGroupCrossoverProgressDto {
    ...
    /**
     * @param firstChromosomeBeginGeneIndex the firstChromosomeBeginGeneIndex to set
     */
    ...
    /**
     * @param secondChromosomeBeginGeneIndex the secondChromosomeBeginGeneIndex to set
     */
    ...
    /**
     * @param firstChromosomeSequencePosition the firstChromosomeSequencePosition to set
     */
    ...
    /**
     * @param secondChromosomeSequencePosition the secondChromosomeSequencePosition to set
     */
