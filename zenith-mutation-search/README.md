...
3. Issue the command `java -XX:+UseParallelGC -XX:ParallelGCThreads=2 -Xms2G -Xmx2G -XX:MaxMetaspaceSize=512M -jar target\zenith-mutation-search-1.1.1-SNAPSHOT.jar`
