...
2. Download zenith-mutation-search-2.0.0.jar
3. Issue the command `java -XX:+UseParallelGC -XX:ParallelGCThreads=2 -Xms2G -Xmx2G -XX:MaxMetaspaceSize=512M -jar zenith-mutation-search-2.0.0.jar`
