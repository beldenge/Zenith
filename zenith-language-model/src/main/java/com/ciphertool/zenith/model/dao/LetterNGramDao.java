...
import com.ciphertool.zenith.model.LanguageModelApplication;
...
public class LetterNGramDao {
    ...
    @PostConstruct
    public void init() {
        if (LanguageModelApplication.class.getSimpleName().equals(appName) || Files.exists(Paths.get(modelFilename))) {
            return;
        }
