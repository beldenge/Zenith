...
/**
 * An interactive interface to the Wigner3j class. The GUI allows to preselect one of the symbols if the number of
 * j-terms is small (6j up to 15j), or to enter any other connectivity for the triads of j-values. The actual j-values
 * are entered as integers (2j+1) and the computation of one value (in exact square root representation) is started
 * manually.
 * 
 * @since 2011-02-15
 */
public class Wigner3jGUI implements ActionListener, ListSelectionListener {
	...
	JList				searJ;
	String[]			searOpt	= { "6j", "9j", "12j 1st", "12j 2nd (not symm)", "15j 1st", "15j 2nd", "15j 3rd",
			"15j 4th", "15j 5th" };
	...
	public void compute() {
		...
		/*
		 * Read the trias configuration from inpGtria into trias[0..2], skipping lines that start with a hash mark.
		 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * debugging System.out.println("Ac"+e.paramString()) ; System.out.println(lin) ;
		 */
		if (lin == "compute") {
			outG.setText("");
			compute();
	 ...
	 * 
	 * @param e
	 *            the information on which of the 3jn templates had been selected in the Menu
	 * @since 2011-02-18
	 * @author Richard J. Mathar
	 */
	public void valueChanged(ListSelectionEvent e) {
		...
		case 1:
			/*
			 * Yutsis Figure 18.1 index map. j1=1, j2=2, j3=3 k1=4, k2=5, k3=6 l1=7, l2=8, l3=9
			 */
			inpGtria.setText("9\n");
		...
		case 2:
			/*
			 * Yutsis Figure 19.1 and 19.2, index map, including the sign reveral of the l. Assume input order j1..j4,
			 * l1..l4, k1..k4. j1=1, j2=2, j3=3, j4=4 l1=5, l2=6, l3=7, l4=8 k1=9, k2=10, k3=11, k4=12
			 */
			inpGtria.setText("12\n");
		...
		case 4:
			/*
			 * Yutsis Figure 20.2 to 20.3, index map. j1=1, j2=2, j3=3, j4=4, j5=5 l1=6, l2=7, l3=8, l4=9, l5=10 k1=11,
			 * k2=12, k3=13, k4=14, k5=15
			 */
			inpGtria.setText("15\n");
		...
		case 6:
			/*
			 * Yutsis Figure 20.4a, index map. k1=1, k1'=2, k=3, k'=4, k2=5, k2'=6 p1=7, p=8, p2=9, j1=10, j1'=11 j=12
			 * j'=13 j2=14 j2'=15
			 */
			inpGtria.setText("15\n");
		...
		case 7:
			/*
			 * Yutsis Figure 20.5a, index map. j1=1, k1=2 s1=3 k1'=4 j1'=5 p=6 l=7 s=8 l'=9 p'=10 j2=11 k2=12 s2=13
			 * k2'=14 j2'=15
			 */
			inpGtria.setText("15\n");
		...
		case 8:
			/*
			 * Yutsis Figure 20.6, index map. k1=1 k1'=2 j1=3 l1=4 l1'=5 k2=6 k2'=7 j2=8 l2=9 l2'=10 k3=11 k3'=12 j3=13
			 * l3=14 l3'=15
			 */
			inpGtria.setText("15\n");
