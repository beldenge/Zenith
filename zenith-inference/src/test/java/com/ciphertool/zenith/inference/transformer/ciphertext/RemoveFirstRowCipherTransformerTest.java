...
public class RemoveFirstRowCipherTransformerTest {
    @Test
    public void testTransform() {
        RemoveFirstRowCipherTransformer cipherTransformer = new RemoveFirstRowCipherTransformer();
        ...
        assertEquals("T", transformed.getCiphertextCharacters().get(1).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(2).getValue());
        ...
        assertEquals("P", transformed.getCiphertextCharacters().get(6).getValue());
        ...
        assertEquals("N", transformed.getCiphertextCharacters().get(9).getValue());
        ...
        assertEquals("G", transformed.getCiphertextCharacters().get(18).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(19).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(20).getValue());
        assertEquals("S", transformed.getCiphertextCharacters().get(21).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(22).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(23).getValue());
        assertEquals("D", transformed.getCiphertextCharacters().get(24).getValue());
