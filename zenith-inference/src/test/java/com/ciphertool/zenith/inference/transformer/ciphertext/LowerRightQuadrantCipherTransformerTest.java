...
public class LowerRightQuadrantCipherTransformerTest {
    @Test
    public void testTransform_OddColumns() {
        LowerRightQuadrantCipherTransformer cipherTransformer = new LowerRightQuadrantCipherTransformer();
        ...
        assertEquals("F", transformed.getCiphertextCharacters().get(3).getValue());
        ...
        assertEquals("X", transformed.getCiphertextCharacters().get(7).getValue());
    ...
    public void testTransform_OddRows() {
        ...
        assertEquals("S", transformed.getCiphertextCharacters().get(0).getValue());
