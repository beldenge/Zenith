...
public class NgramAndIndexOfCoincidencePlaintextEvaluatorUnitTest {
    @Test
    public void given_validInputs_when_evaluating_then_returnsExpectedFitness() {
        ...
        when(indexEvaluator.evaluate(precomputed, cipher, solutionString)).thenReturn(0.22f);
