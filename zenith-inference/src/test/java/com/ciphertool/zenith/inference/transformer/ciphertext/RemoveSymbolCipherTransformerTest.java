...
public class RemoveSymbolCipherTransformerTest {
    ...
    public void given_validInput_when_transform_then_returnsExpectedValue() {
        ...
        assertEquals(36, transformed.getColumns());
        assertEquals(1, transformed.getRows());
        ...
        assertEquals("O", transformed.getCiphertextCharacters().get(5).getValue());
        ...
        assertEquals("P", transformed.getCiphertextCharacters().get(9).getValue());
        ...
        assertEquals("H", transformed.getCiphertextCharacters().get(15).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(16).getValue());
        ...
        assertEquals("G", transformed.getCiphertextCharacters().get(19).getValue());
