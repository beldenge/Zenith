...
public class TopLeftDiagonalCipherTransformerTest {
    @Test
    public void testTransform() {
        TopLeftDiagonalCipherTransformer cipherTransformer = new TopLeftDiagonalCipherTransformer();
        ...
        assertEquals("H", transformed.getCiphertextCharacters().get(2).getValue());
        assertEquals("P", transformed.getCiphertextCharacters().get(3).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(4).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(5).getValue());
        ...
        assertEquals("T", transformed.getCiphertextCharacters().get(9).getValue());
        assertEquals("G", transformed.getCiphertextCharacters().get(10).getValue());
        ...
        assertEquals("I", transformed.getCiphertextCharacters().get(13).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(14).getValue());
        assertEquals("D", transformed.getCiphertextCharacters().get(15).getValue());
        ...
        assertEquals("S", transformed.getCiphertextCharacters().get(19).getValue());
        assertEquals("M", transformed.getCiphertextCharacters().get(20).getValue());
        assertEquals("L", transformed.getCiphertextCharacters().get(21).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(22).getValue());
        ...
        assertEquals("T", transformed.getCiphertextCharacters().get(25).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(26).getValue());
        assertEquals("Y", transformed.getCiphertextCharacters().get(27).getValue());
        assertEquals("F", transformed.getCiphertextCharacters().get(28).getValue());
        assertEquals("S", transformed.getCiphertextCharacters().get(29).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(30).getValue());
        assertEquals("I", transformed.getCiphertextCharacters().get(31).getValue());
        ...
        assertEquals("H", transformed.getCiphertextCharacters().get(34).getValue());
        ...
        assertEquals("M", transformed.getCiphertextCharacters().get(37).getValue());
        ...
        assertEquals("I", transformed.getCiphertextCharacters().get(40).getValue());
