...
public class RotateClockwiseCipherTransformerTest {
    @Test
    public void testTransform() {
        RotateCounterClockwiseCipherTransformer cipherTransformer = new RotateCounterClockwiseCipherTransformer();
        ...
        assertEquals("I", transformed.getCiphertextCharacters().get(5).getValue());
        ...
        assertEquals("N", transformed.getCiphertextCharacters().get(10).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(11).getValue());
        assertEquals("M", transformed.getCiphertextCharacters().get(12).getValue());
        ...
        assertEquals("I", transformed.getCiphertextCharacters().get(15).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(16).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(17).getValue());
        assertEquals("S", transformed.getCiphertextCharacters().get(18).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(19).getValue());
        assertEquals("X", transformed.getCiphertextCharacters().get(20).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(21).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(22).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(23).getValue());
        ...
        assertEquals("T", transformed.getCiphertextCharacters().get(29).getValue());
        ...
        assertEquals("E", transformed.getCiphertextCharacters().get(33).getValue());
        assertEquals("Y", transformed.getCiphertextCharacters().get(34).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(35).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(36).getValue());
        assertEquals("P", transformed.getCiphertextCharacters().get(37).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(38).getValue());
        assertEquals("G", transformed.getCiphertextCharacters().get(39).getValue());
        assertEquals("D", transformed.getCiphertextCharacters().get(40).getValue());
