...
public class NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluatorTest {
    @Test
    public void given_validInputs_when_evaluating_then_returnsMultiObjectiveScores() {
        ...
        NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator evaluator = new NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator(model, indexEvaluator, precomputed);
        ...
        assertEquals(0.18d, scores[1].getValue(), 0.000001d);
    ...
    public void given_cipher_when_getPrecomputedCounterweightData_then_delegatesToEvaluator() {
        ...
        NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator evaluator = new NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator(model, indexEvaluator, Collections.emptyMap());
    ...
    public void given_data_when_getInstance_then_returnsNewEvaluator() {
        ...
        NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator evaluator = new NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator(model, indexEvaluator, data);
        PlaintextEvaluator instance = evaluator.getInstance(data);

        assertNotNull(instance);
        assertNotSame(evaluator, instance);
        assertEquals(NgramAndIndexOfCoincidenceMultiObjectivePlaintextEvaluator.class, instance.getClass());
    }
