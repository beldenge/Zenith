...
public class PeriodCipherTransformerTest {
    ...
    public void testTransform() {
        ...
        assertEquals("S", transformed.getCiphertextCharacters().get(2).getValue());
        ...
        assertEquals("H", transformed.getCiphertextCharacters().get(5).getValue());
        ...
        assertEquals("A", transformed.getCiphertextCharacters().get(10).getValue());
        ...
        assertEquals("E", transformed.getCiphertextCharacters().get(13).getValue());
        ...
        assertEquals("X", transformed.getCiphertextCharacters().get(17).getValue());
        ...
        assertEquals("P", transformed.getCiphertextCharacters().get(20).getValue());
        ...
        assertEquals("F", transformed.getCiphertextCharacters().get(24).getValue());
        assertEquals("Y", transformed.getCiphertextCharacters().get(25).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(26).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(27).getValue());
        assertEquals("L", transformed.getCiphertextCharacters().get(28).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(29).getValue());
        ...
        assertEquals("G", transformed.getCiphertextCharacters().get(38).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(39).getValue());
