...
public class UnwrapPeriodCipherTransformerTest {
    @Test
    public void testTransform() {
        UnwrapPeriodCipherTransformer cipherTransformer = new UnwrapPeriodCipherTransformer(Collections.singletonMap(AbstractPeriodCipherTransformer.LENGTH, 5));

        Cipher cipher = new Cipher("tomato", 7, 6);

        cipher.addCiphertextCharacter(new Ciphertext(0, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(1, "M"));
        cipher.addCiphertextCharacter(new Ciphertext(2, "S"));
        cipher.addCiphertextCharacter(new Ciphertext(3, "N"));
        cipher.addCiphertextCharacter(new Ciphertext(4, "H"));
        cipher.addCiphertextCharacter(new Ciphertext(5, "H"));
        cipher.addCiphertextCharacter(new Ciphertext(6, "D"));
        cipher.addCiphertextCharacter(new Ciphertext(7, "I"));
        cipher.addCiphertextCharacter(new Ciphertext(8, "X"));
        cipher.addCiphertextCharacter(new Ciphertext(9, "H"));
        cipher.addCiphertextCharacter(new Ciphertext(10, "A"));
        cipher.addCiphertextCharacter(new Ciphertext(11, "A"));
        cipher.addCiphertextCharacter(new Ciphertext(12, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(13, "E"));
        cipher.addCiphertextCharacter(new Ciphertext(14, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(15, "E"));
        cipher.addCiphertextCharacter(new Ciphertext(16, "L"));
        cipher.addCiphertextCharacter(new Ciphertext(17, "X"));
        cipher.addCiphertextCharacter(new Ciphertext(18, "E"));
        cipher.addCiphertextCharacter(new Ciphertext(19, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(20, "P"));
        cipher.addCiphertextCharacter(new Ciphertext(21, "I"));
        cipher.addCiphertextCharacter(new Ciphertext(22, "N"));
        cipher.addCiphertextCharacter(new Ciphertext(23, "S"));
        cipher.addCiphertextCharacter(new Ciphertext(24, "F"));
        cipher.addCiphertextCharacter(new Ciphertext(25, "Y"));
        cipher.addCiphertextCharacter(new Ciphertext(26, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(27, "O"));
        cipher.addCiphertextCharacter(new Ciphertext(28, "L"));
        cipher.addCiphertextCharacter(new Ciphertext(29, "N"));
        cipher.addCiphertextCharacter(new Ciphertext(30, "I"));
        cipher.addCiphertextCharacter(new Ciphertext(31, "H"));
        cipher.addCiphertextCharacter(new Ciphertext(32, "A"));
        cipher.addCiphertextCharacter(new Ciphertext(33, "X"));
        cipher.addCiphertextCharacter(new Ciphertext(34, "O"));
        cipher.addCiphertextCharacter(new Ciphertext(35, "I"));
        cipher.addCiphertextCharacter(new Ciphertext(36, "A"));
        cipher.addCiphertextCharacter(new Ciphertext(37, "T"));
        cipher.addCiphertextCharacter(new Ciphertext(38, "G"));
        cipher.addCiphertextCharacter(new Ciphertext(39, "A"));
