...
public class RotateCounterClockwiseCipherTransformerTest {
    @Test
    public void testTransform() {
        RotateClockwiseCipherTransformer cipherTransformer = new RotateClockwiseCipherTransformer();
        ...
        assertEquals("L", transformed.getCiphertextCharacters().get(0).getValue());
        assertEquals("D", transformed.getCiphertextCharacters().get(1).getValue());
        assertEquals("G", transformed.getCiphertextCharacters().get(2).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(3).getValue());
        ...
        assertEquals("E", transformed.getCiphertextCharacters().get(8).getValue());
        ...
        assertEquals("T", transformed.getCiphertextCharacters().get(12).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(13).getValue());
        assertEquals("X", transformed.getCiphertextCharacters().get(14).getValue());
        assertEquals("F", transformed.getCiphertextCharacters().get(15).getValue());
        ...
        assertEquals("O", transformed.getCiphertextCharacters().get(19).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(20).getValue());
        assertEquals("X", transformed.getCiphertextCharacters().get(21).getValue());
        ...
        assertEquals("E", transformed.getCiphertextCharacters().get(24).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(25).getValue());
        ...
        assertEquals("X", transformed.getCiphertextCharacters().get(28).getValue());
        assertEquals("M", transformed.getCiphertextCharacters().get(29).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(30).getValue());
        assertEquals("N", transformed.getCiphertextCharacters().get(31).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(32).getValue());
        assertEquals("S", transformed.getCiphertextCharacters().get(33).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(34).getValue());
        assertEquals("X", transformed.getCiphertextCharacters().get(35).getValue());
        assertEquals("I", transformed.getCiphertextCharacters().get(36).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(37).getValue());
        assertEquals("I", transformed.getCiphertextCharacters().get(38).getValue());
        assertEquals("I", transformed.getCiphertextCharacters().get(39).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(40).getValue());
