...
public class ReverseCipherTransformerTest {
    ...
    public void testTransform() {
        ...
        assertEquals("Y", transformed.getCiphertextCharacters().get(4).getValue());
        ...
        assertEquals("M", transformed.getCiphertextCharacters().get(7).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(8).getValue());
        assertEquals("F", transformed.getCiphertextCharacters().get(9).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(10).getValue());
        assertEquals("D", transformed.getCiphertextCharacters().get(11).getValue());
        ...
        assertEquals("S", transformed.getCiphertextCharacters().get(14).getValue());
        ...
        assertEquals("G", transformed.getCiphertextCharacters().get(17).getValue());
        ...
        assertEquals("N", transformed.getCiphertextCharacters().get(26).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(27).getValue());
        assertEquals("L", transformed.getCiphertextCharacters().get(28).getValue());
        assertEquals("P", transformed.getCiphertextCharacters().get(29).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(30).getValue());
        assertEquals("S", transformed.getCiphertextCharacters().get(31).getValue());
        assertEquals("I", transformed.getCiphertextCharacters().get(32).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(33).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(34).getValue());
        assertEquals("A", transformed.getCiphertextCharacters().get(35).getValue());
        assertEquals("M", transformed.getCiphertextCharacters().get(36).getValue());
        assertEquals("O", transformed.getCiphertextCharacters().get(37).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(38).getValue());
        assertEquals("E", transformed.getCiphertextCharacters().get(39).getValue());
        assertEquals("H", transformed.getCiphertextCharacters().get(40).getValue());
        assertEquals("T", transformed.getCiphertextCharacters().get(41).getValue());
