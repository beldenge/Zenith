...
public class PlaintextEvaluatorWrappingFitnessEvaluator implements FitnessEvaluator {
    ...
    public Double evaluate(Chromosome chromosome) {
        CipherSolution cipherSolution = chromosomeToCipherSolution(chromosome);
    ...
    public CipherSolution chromosomeToCipherSolution(Chromosome chromosome) {
        // TODO: Actually convert the Chromosome to a CipherSoltuion
