...
public class NgramAndChiSquaredPlaintextEvaluator extends AbstractNgramEvaluator implements PlaintextEvaluator {
    ...
    public NgramAndChiSquaredPlaintextEvaluator(ArrayMarkovModel letterMarkovModel, ChiSquaredEvaluator chiSquaredEvaluator, Map<String, Object> data) {
    ...
    public PlaintextEvaluator getInstance(Map<String, Object> data) {
        return new NgramAndChiSquaredPlaintextEvaluator(letterMarkovModel, chiSquaredEvaluator, data);
    }
    ...
    public String getHelpText() {
        return "Uses a character-level n-gram model along with the chi-squared test.";
    }
}
